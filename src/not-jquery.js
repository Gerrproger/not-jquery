  ...
  njProto.transitionEnd = function (f, target, propName, pseudoEl) {
    return this.on(
      ...
      function (ev) {
        ...
        if (
          (propName && propName !== ev.propertyName) ||
          (pseudoEl && '::' + pseudoEl !== ev.pseudoElement)
        ) {
          return;
        }
  ...
  var Ajax = function Ajax() {
    ...
    return function init(settings, success, fail) {
      ...
      if ((set.method === 'GET' || set.method === 'HEAD') && settings.params) {
        ...
        settings.url += Object.keys(settings.params)
          .map(function (key) {
      ...
      if (settings.form) {
        ...
        (set.method === 'POST' || set.method === 'PUT') &&
        set.body === null &&
        settings.params
      ) {
